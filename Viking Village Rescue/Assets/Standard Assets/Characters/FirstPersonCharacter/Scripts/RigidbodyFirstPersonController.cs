...
//		int isStopped = 0;
		...
		// play some music
		[FMODUnity.EventRef]
		public string pylonMusic;
		FMOD.Studio.EventInstance pylonMusicInst;




		float distanceFromMix = 0;
		float distanceFromDrama = 0;


		// this stuff is what unity will see:
...
//======================== START ===========================			
        ...
        private void Update()
        {
			...
			// find distance to pylon_01

			pylon_1 = Vector3.Distance (MixObject.transform.position, transform.position);
//			print ("Pylon 1 " + pylon_1);


			//pylon 1 is backwards. I want the numbers to go small to big, so...
			pylon_1_inverse = 50 - pylon_1;


			// link distance parameter to FMOD param

			// pylonMusicInst.setParameterValue ("Mix", pylon_1);
        ...
        {
			//make sure walking is working
			print ("Walking is " +isWalking);
